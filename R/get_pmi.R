...
get_pmi <- function(doc, keyword, window = 6, ngram = 1, remove_stopwords = TRUE, min_count = 2){

      internal_pmi <- internal_get_pmi(doc, keyword, window, ngram, remove_stopwords, min_count)
